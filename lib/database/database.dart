...
void saveLocationSelected(String locationSelected)async{
  await Hive.openBox('locationSelected');
  var apiBox = Hive.box('locationSelected');
  apiBox.put('locationSelected', locationSelected);
}

Future<String?> getLocationSelected()async{
  await Hive.openBox('locationSelected');
  var box =  Hive.box('locationSelected');
  String? locationSelected = await box.get('locationSelected');
